...
public class ViewAOrders extends JFrame{ 
    ...
    private JLabel lblfid;
        ...
        public ViewAOrders()
        {
            super("Viewing All Orders");
        
            JPanel p1 = new JPanel();
            p1.setBackground(new Color(238,64,23));
            p1.setBounds(0, 0, 720, 50);
            p1.setLayout(null);
            JLabel l1 = new JLabel(" Viewing All Orders");
            ...
            p3.setBackground(Color.WHITE);
                ...
                try{
                    conn c = new conn();
                    String s1 = "select * from orders order by odate desc,otime desc";
