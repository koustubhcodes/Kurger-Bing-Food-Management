...
public class ViewNOrders extends JFrame{ 
    ...
    private JLabel lblfid;
        ...
        public ViewNOrders()
        {
            super("Viewing New Orders");
        
            JPanel p1 = new JPanel();
            p1.setBackground(new Color(238,64,23));
            p1.setBounds(0, 0, 720, 50);
            p1.setLayout(null);
            JLabel l1 = new JLabel(" Viewing New Orders");
            ...
            p3.setBackground(Color.WHITE);
                ...
                try{
                    conn c = new conn();
                    String s1 = "select * from orders where status = 1 order by odate desc,otime desc";
		...
		p2.add(btnExit);
            ...
            JFrame frame = new JFrame("Viewing New Orders");
