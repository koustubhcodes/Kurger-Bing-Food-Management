...
public class FoodMenu1 extends JFrame{ 
    ...
    private JLabel lblfid;
        ...
        public FoodMenu1()
        {
            ...
            ImageIcon z5 = new ImageIcon(ClassLoader.getSystemResource("fmsicons/foodmenu.png"));
            Image z51 = z5.getImage().getScaledInstance(40, 45,Image.SCALE_DEFAULT);
