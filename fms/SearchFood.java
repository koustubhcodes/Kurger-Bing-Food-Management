...
public class SearchFood extends JFrame{ 
    ...
    JLabel l11, l12, l13, l14, l15;
        ...
        public SearchFood()
        {
            ...
            p1.setLayout(null);
            JLabel l1 = new JLabel("Search Food");
            ...
            JLabel SearchE = new JLabel("Search Food");
            ...
            /*JLabel lab1 = new JLabel("Food ID");
            p4.add(lab1);
            l11 = new JLabel();
            p4.add(l11);*/
            
            JLabel lab2 = new JLabel("Food Name");
            p4.add(lab2);
            l12 = new JLabel();            
            p4.add(l12);
            
            JLabel lab3 = new JLabel("Food Type");
            p4.add(lab3);
            l13 = new JLabel();
            p4.add(l13);
            ...
            JLabel lab5 = new JLabel("Calories");
            p4.add(lab5);
            l15 = new JLabel();
            p4.add(l15);
		...
		btnSearchData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    ...
                                    conn c = new conn();
                                    String displayCustomersql = "select fname,ftype,price,cal from food where fid = '"+tempq+"'";
                                    ...
                                    if(rs.next()==false)
                                    {
                                        ...
                                        l12.setText(rs.getString("fname"));
                                        l13.setText(rs.getString("ftype"));
                                        l14.setText(rs.getString("price"));
                                        l15.setText(rs.getString("cal"));
                                    }
                                    JButton deleteEmp = new JButton("Delete Employee");
                                    deleteEmp.addActionListener(new ActionListener(){
                                        public void actionPerformed(ActionEvent e){
                                            try{
                                                String displayCustomersql = "delete from food where fid = '"+tempq+"'"; //insert delete query here
                                    ...
                                    editEmp.addActionListener(new ActionListener(){
                                        public void actionPerformed(ActionEvent e){
                                            try{
                                                new UpdateFood(tempq).setVisible(true);
                                                setVisible(false);
                                            }
                                            catch(Exception e1){
                                                e1.printStackTrace();
		...
		p2.add(btnSearchData);
                ...
                JFrame frame = new JFrame("Search Food - Kurger Bing");
